    ...
    <section id="client" className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
      <div className="container mx-auto px-4">
        ...
        <div className="relative overflow-hidden py-8">
          ...
          {/* 오른쪽 그라디언트 */}
          <div className="absolute right-0 top-0 bottom-0 w-16 md:w-32 bg-gradient-to-l from-blue-50 to-transparent z-10"></div>
          ...
          <div className="flex animate-scroll">
            ...
            {clients.map((client, index) => (
              <div
                key={`first-${index}`}
                className="flex-shrink-0 mx-1 md:mx-6 bg-white rounded-lg md:rounded-xl shadow-md hover:shadow-xl transition-all duration-300 px-3 py-2.5 md:px-8 md:py-6 w-[80px] md:min-w-[200px] h-[65px] md:h-[120px] flex items-center justify-center hover:scale-105"
              >
                <Image
                  src={client.logo}
                  alt={client.name}
